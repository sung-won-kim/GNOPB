...
def main(args):
    ...
    for s_id, seed in enumerate(range(args.seed, args.seed + args.num_seed)):
        ...
        # Split dataset via timestep split
        train_case = [10,20,30,40,50,60,70]
        val_case = [80,90]
        test_case = [100,110,120]

        train_g_list, val_g_list, test_g_list = [], [], []
        for data in G_list:
            case_number = data['target_timestep']
...
if __name__ == '__main__':
    ...
    def parse_args():
        ...
        parser.add_argument("--summary", type=str, default=f'[table1]_unseen_time')
